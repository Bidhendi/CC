# Tensile tester V2020.1 
# Amir J Bidhendi, Email: amir.bidhendi@mcgill.ca
#
# Disclaimer: the script is shared as is and it can be used in any ways the user sees fit. Please consider citing the main
# Publication if you found this code useful.
#
# Amir J. Bidhendi , M. Shafayet Zamil , Anja Geitmann,"Assembly of a simple scalable device for micromechanical testing of # plant tissues", Methods in Cell Biology, https://doi.org/10.1016/bs.mcb.2020.04.003
 
# The script generates ex1.csv file with first column the LVDT data () and
# the second column is load cell data ()
import sys
import time
